...
/***
 * 
 * You can either extend the Thread class and override its run() method to define the thread's task 
 * or implement the Runnable interface and pass an instance of the class to the Thread constructor. 
